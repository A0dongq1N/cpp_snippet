...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "v2.3"
  WORKING_DIRECTORY "/data/workspace/github/cpp_snippet/indicators/build/_deps/indicators-src"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("v2.3" tag_sha error_msg)
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/data/workspace/github/cpp_snippet/indicators/build/_deps/indicators-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/data/workspace/github/cpp_snippet/indicators/build/_deps/indicators-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
